					...
					<view class="colonn p-all-30">
						...
						<block>
							...
							<view class="colonn center_center">
								<view class="fs-40 w-690">1.根据影像学资料给出正确的病例诊断结果（25分）</view>
								<view class="h-20"></view>
							...
							<view class="h-20"></view>
							<view class="colonn center_center">
								<view class="fs-40 w-690">2.诊断思路阐述逻辑清晰有条理，表述完整精炼，重点突出(30分)</view>
								<view class="h-20"></view>
								<input type="number" class="textawa" v-model="fens.fen2"
									@input="isFenSubChange($event,1)" placeholder="最高30分"></input>
							</view>
							<view style="color: red;" v-if="!heTishi[1]">第2项得分必须小于等于30</view>
							<view class="h-20"></view>
							<view class="colonn center_center">
								<view class="fs-40 w-690">3.含有针对性的鉴别诊断，鉴别诊断结合病人具体病情、影像征象及发病率(25分)</view>
								<view class="h-20"></view>
							...
							<view class="h-20"></view>
							<view class="colonn center_center">
								<view class="fs-40 w-690">4.能够提出有利于诊断和鉴别诊断的合理建议(15分)</view>
								<view class="h-20"></view>
								<input type="number" class="textawa" v-model="fens.fen4"
									@input="isFenSubChange($event,3)" placeholder="最高15分"></input>
							</view>
							<view style="color: red;" v-if="!heTishi[3]">第4项得分必须小于等于15</view>
							<view class="h-20"></view>
							<view class="colonn center_center">
								<view class="fs-40  w-690">5.语言表达清晰完整，声音洪亮，语速和节奏适中，PPT制作规范，排版美观(5分)</view>
								<view class="h-20"></view>
								<input type="number" class="textawa" v-model="fens.fen5"
									@input="isFenSubChange($event,4)" placeholder="最高5分"></input>
							</view>
							<view style="color: red;" v-if="!heTishi[4]">第5项得分必须小于等于5</view>
						</block>
